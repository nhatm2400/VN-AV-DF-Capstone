...
Tests kiểm tra kỹ thuật bằng fixture/mock/media tổng hợp; không phải bộ test accuracy của detector. `test_research_data_contract.py` kiểm tra các ràng buộc dùng chung giữa manifest/split/media. Test model/train chưa có vì model mới chưa triển khai.
