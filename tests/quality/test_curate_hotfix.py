...
CURATE_PATH = ROOT / "src/data/preparation/quality/curate.py"
...
class CurateHotfixTest(unittest.TestCase):
    ...
    def test_temporal_gate_rejects_only_when_locked_policy_passed(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            rejected = pd.read_csv(root / "curated_rejects.csv")
    ...
    def test_outputs_form_complete_disjoint_partition_and_refuse_overwrite(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            rejected_path = root / "curated_rejects.csv"
            balance_path = root / "curated_balance_dropped.csv"
            config_path = root / "curated_config.json"
            clean = pd.read_csv(output)
