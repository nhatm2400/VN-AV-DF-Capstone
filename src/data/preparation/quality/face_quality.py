...
LOCAL (mặc định — chạy KHÔNG cần tham số, từ thư mục gốc dự án):
  python src/data/preparation/quality/face_quality.py
  -> đọc data/manifests/dataset_v1/clips.csv, xuất
     cache/quality/dataset_v1/tier1_scored_all.csv + embeddings_all.npy
...
KAGGLE: python src/data/preparation/quality/face_quality.py --input_csv /kaggle/working/all_manifest.csv --out_dir /kaggle/working
...
def main():
    ...
    ap.add_argument("--input_csv", default="data/manifests/dataset_v1/clips.csv",
                    help="manifest từ 01_prep_manifest (mặc định local)")
    ap.add_argument("--out_dir", default="cache/quality/dataset_v1")
