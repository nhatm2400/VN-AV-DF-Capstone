...
Có thêm `predict.py`: hàm predict_batch nhận model và feature audio/visual, trả fake_score và nhãn dự đoán. Ngưỡng mặc định 0.5 chỉ để kiểm tra luồng code. Chưa có tính AUC/EER, báo cáo generator/nén hoặc chạy final test.
